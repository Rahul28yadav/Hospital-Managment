...
public class MasterController {
    ...
    public ModelAndView showLoginPage(ModelAndView model){
	 ...
	 @RequestMapping(value="/login", method = RequestMethod.POST)
	    public ModelAndView showWelcomePage(ModelMap model, @RequestParam String emailid, @RequestParam String password ){
		 ModelAndView model1 = new ModelAndView();
		 System.out.println();
	        String isValidUser = lservice.validateUser(emailid, password);
